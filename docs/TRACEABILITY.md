# Traceability Matrix — TC ↔ Automation

> Generated by `node scripts/validate-cases.js`; the Automation column is scanned from the specs under tests/.
> Total: **128 cases** · Smoke: **14** · Automated: **128** · Source: docs/cases/*.csv

## Auth (`auth.csv`, 15 cases)
...
## Product Discovery (`product_discovery.csv`, 18 cases)
...
## Product Detail (`product_detail.csv`, 10 cases)
...
## Checkout (`checkout.csv`, 15 cases)
